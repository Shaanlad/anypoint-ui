            ...
            <main className="flex min-h-screen flex-col items-center justify-between p-24">
                ...
                <div className="z-10 max-w-5xl items-center justify-between font-sans text-sm"> 
                    ...
                    {data && data.map((item: any, index: number) => (
                        <li key={index} className='text-black	fixed left-0 top-0 flex w-full justify-centre border-b border-gray-300 pb-6 pt-8 backdrop-blur-2xl dark:bg-zinc-800/30 lg:static lg:w-auto lg:border lg:bg-gray-200 lg:p-4 shadow-lg hover:bg-blue-600/50'>
                        <span>
                            <p>
                            {item.name}
                            </p>
                ...
                <div className="bg-blue-500">
                    <Link 
                        ...
                        href="/"> Back To Home (Future Logout)
                    </Link>
                </div> 
            </main>
        </>
